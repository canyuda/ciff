...
| 数据库 | 表 | 用途 |
|--------|---|------|
| MySQL 8.x | t_user, t_provider, t_model, t_agent, t_agent_tool, t_agent_knowledge, t_tool, t_workflow, t_knowledge, t_knowledge_document, t_conversation, t_chat_message, t_api_key | 业务数据（共 13 张） |
